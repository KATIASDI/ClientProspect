...
<div class="mt-auto p-3">
    <a id="linkLogout" runat="server" 
       ...
       class="btn btn-outline-danger w-100 d-flex align-items-center justify-content-center">
        ...
        <!-- Contenu principal -->
        <div class="col-md-10 main-content container-chart">
        <div class="card-form">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TBNom" ErrorMessage="Champ Obligatoire " ForeColor="Red"></asp:RequiredFieldValidator>
        </div>
        <div class="col-md-6 mb-3">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="DDLSecteur" ErrorMessage="Champ obligatoire" ForeColor="Red"></asp:RequiredFieldValidator>
        ...
        <div class="col-md-6 mb-3">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="DDLSSecteur" ErrorMessage="Champ obligatoire" ForeColor="Red"></asp:RequiredFieldValidator>
        ...
        function ShowAlert(title, message, icon) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'AjoutClient.aspx'; // redirige vers une autre page
                }
            });
        }
    </script>
